...
/**
 * Set/clear a GPIO port bit.
 *
 * portNum: the number of the port to set
 * bitPosi: the bit of the port to set
 * bitVal:  the bit value
 */
...
{
	uint32_t mask = 1 << bitPosi;
	return LPC_GPIO[portNum]->MASKED_ACCESS[mask] & mask;
}

/**
 * Set the direction of a GPIO port
 *
 * portNum: the number of the port to set
 * bitPosi: the bit of the port to set
