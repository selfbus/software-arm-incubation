...
#Daten:     77 95 00 08 02
	...
	def __init__(self):
		...
		self.byte4_5 = -1
		self.byte4_4 = -1
		self.ManualSwitchedToTapWater = -1
		self.byte4_2 = -1
		self.Alarm = -1
		self.byte4_0 = -1
	...
	def Decode(self):
		...
		if (self.data[0] == ord(rcDisplayMessage.msgIdentifier)) and (len(self.data) >= rcDisplayMessage.msgLength):
			...
			self.byte4_5 = bit_is_set(self.data[3], 5)
			self.byte4_4 = bit_is_set(self.data[3], 4)
			
			self.ManualSwitchedToTapWater = bit_is_set(self.data[3], 3)
			self.byte4_2 = bit_is_set(self.data[3], 2)
			self.Alarm = bit_is_set(self.data[3], 1)
	...
	def GetLongToInformationText(self):
		...
		InformationText += ' Byte 4:                  {0:0d} {1:0d} {2:0d} {3:0d}    {4:0d} {5:0d} {6:0d} {7:0d}\n'.format(self.byte4_7, self.byte4_6, self.byte4_5, self.byte4_4, self.ManualSwitchedToTapWater, self.byte4_2, self.Alarm, self.byte4_0)
		InformationText += ' Byte 5:                  {0:0d} {1:0d} {2:0d} {3:0d}    {4:0d} {5:0d} {6:0d} {7:0d}\n'.format(self.QubicMeters, self.Percent, self.byte5_5, self.byte5_4, self.byte5_3, self.byte5_2, self.Alarm, self.byte5_1, self.byte5_0)
		return InformationText
