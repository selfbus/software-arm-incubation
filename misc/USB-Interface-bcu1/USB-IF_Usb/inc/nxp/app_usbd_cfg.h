...
#define HID_EP_IN                           0x81 // EP01_IN
#define HID_EP_OUT                          0x01 // EP01_OUT
#define USB_HID_IF_NUM                      0
/** Interval between reports expressed in milliseconds for full-speed device. */
#define HID_REPORT_INTERVAL_MS        2
/* bInterval value used in descriptor. For HS this macro will differ from HID_REPORT_INTERVAL_MS macro. */
#define HID_REPORT_INTERVAL           2
...
#define USB_CDC_INT_EP                      0x82 // EP02_IN
#define USB_CDC_IN_EP                       0x83 // EP03_IN
#define USB_CDC_OUT_EP                      0x03 // EP03_OUT
...
extern uint8_t USBSngl_FsConfigDescriptor[];
